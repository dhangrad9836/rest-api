...
export default function Home() {
  //create endpoints array with objects
  const endpoints = [
    {
      name: "GET /trips",
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          {/* map through the endpoints array */}
            ...
            <div className={styles.card}>
              ...
              {endpoint.parameters && (
                <>
                  ...
                  <p>parameters:</p>
                  <ul>
                    {/* you have to add the index b/c this is an array we are mapping through */}
          ...
          {/* end of endpoints mapping the entire array */}
        </div>
      </main>
    </div>
  );
